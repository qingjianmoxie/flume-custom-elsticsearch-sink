...
public interface ElasticSearchSinkConstants {
    ...
    public static final String CONTENT_FLAG = "contentFlag";

    public static final String INDEX_AMOUNT = "indexAmount";
    ...
    public static final String DEFAULT_SERIALIZER_CLASS =
            "com.hujinwen.flume.sink.elasticsearch.ElasticSearchLogStashEventSerializer";
    public static final String DEFAULT_INDEX_NAME_BUILDER_CLASS =
            "com.hujinwen.flume.sink.elasticsearch.TimeBasedIndexNameBuilder";
}
