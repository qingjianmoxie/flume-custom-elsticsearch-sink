...
import com.hujinwen.flume.sink.elasticsearch.client.ElasticSearchClient;
import com.hujinwen.flume.sink.elasticsearch.client.ElasticSearchClientFactory;
...
import static com.hujinwen.flume.sink.elasticsearch.ElasticSearchSinkConstants.*;
import static org.apache.flume.api.RpcClientConfigurationConstants.DEFAULT_CLIENT_TYPE;
    ...
    public Status process() throws EventDeliveryException {
        ...
        try {
            ...
            if (count <= 0) {
                ...
                client.execute(indexNameBuilder);
            }
            txn.commit();
